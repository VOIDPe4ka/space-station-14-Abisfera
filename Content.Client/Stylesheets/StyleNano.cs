...
// ListContainer
                ...
                Element<PanelContainer>().Class(ClassAngleRect)
                    ...
                    .Prop(Control.StylePropertyModulateSelf, Color.FromHex("#2025252A")), // 50% прозрачности
                Element<PanelContainer>().Class("BackgroundOpenRight")
                    .Prop(PanelContainer.StylePropertyPanel, BaseButtonOpenRight)
                    .Prop(Control.StylePropertyModulateSelf, Color.FromHex("#25252A")), // 50% прозрачности
